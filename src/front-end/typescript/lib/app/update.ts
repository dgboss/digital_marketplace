  ...
  switch (msg.tag) {
    ...
    case "@toast":
      return [
        ...
        async (state, dispatch) => {
          ...
          setTimeout(
            () => dispatch(adt("dismissLapsedToasts")),
    ...
    case "pageOpportunityCWUView":
      return updateAppChildPage({
        ...defaultPageUpdateParams,
        mapChildMsg: (value) => ({
          tag: "pageOpportunityCWUView" as const,
          value
        }),
        childStatePath: ["pages", "opportunityCWUView"],
    ...
    case "pageProposalSWUExportAll":
      return updateAppChildPage({
        ...defaultPageUpdateParams,
        mapChildMsg: (value) => ({
          tag: "pageProposalSWUExportAll" as const,
          value
        }),
        childStatePath: ["pages", "proposalSWUExportAll"],
